export function constrain(value, minimum, maximum) {
  return Math.max(Math.min(value, maximum), minimum);
}

export function map(value, begin1, end1, begin2, end2, constrained = true) {
...
export function lowerBound(elements, value, cmp, args = [])  {
...
export function upperBound(elements, value, cmp, args = []) {
...
export function binarySearch(elements, value, cmp, args = []) {
    let begin = 0, end = elements.length; // [begin, end)
...
export function fuzzyEquals(a, b, epsilon) {
