...
import TypedArrayContainer from './TypedArrayContainer.js';


describe('TypedArrayContainer', () => {
    describe('.length', () => {
        it('returns underline array length', () => {
            const view = new TypedArrayContainer(new ArrayBuffer(32));
    ...
    describe('.writeInt16()', () => {
        it('writes positive (2 bytes) at index 1', () => {
            const view = new TypedArrayContainer(new ArrayBuffer(32));
            view.writeInt16(1, 32000);
            expect(view.readInt16(1)).toBe(32000);
        });

        it('writes negative (2 bytes) at index 1', () => {
            const view = new TypedArrayContainer(new ArrayBuffer(32));
            view.writeInt16(1, -32000);
            expect(view.readInt16(1)).toBe(-32000);
        });
